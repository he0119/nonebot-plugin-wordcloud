...
| 功能         | 命令        | 权限                                | 说明                 |
| :----------- | :---------- | :---------------------------------- | :------------------- |
| 查看今日词云 | `/今日词云` | 所有人（`command.wordcloud.query`） | 获取今日的词云       |
| 查看昨日词云 | `/昨日词云` | 所有人（`command.wordcloud.query`） | 获取昨日的词云       |
| 查看本周词云 | `/本周词云` | 所有人（`command.wordcloud.query`） | 获取本周的词云       |
| 查看上周词云 | `/上周词云` | 所有人（`command.wordcloud.query`） | 获取上周的词云       |
| 查看本月词云 | `/本月词云` | 所有人（`command.wordcloud.query`） | 获取本月的词云       |
| 查看上月词云 | `/上月词云` | 所有人（`command.wordcloud.query`） | 获取上月的词云       |
| 查看年度词云 | `/年度词云` | 所有人（`command.wordcloud.query`） | 获取年度的词云       |
| 查看历史词云 | `/历史词云` | 所有人（`command.wordcloud.query`） | 获取指定时间段的词云 |
...
未配置权限插件授权时，原有 NoneBot 超级用户、OneBot V11 群主和管理员权限仍然可用。

- 管理词云

| 功能                 | 命令                                                                   | 权限                                                 | 说明                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| :------------------- | ---------------------------------------------------------------------- | :--------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 设置词云形状         | `/设置词云形状`                                                        | 超级用户/群主/管理员 或 `command.wordcloud.mask`     | 发送一张图片作为当前群词云形状，每个群各自独立                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 删除词云形状         | `/删除词云形状`                                                        | 超级用户/群主/管理员 或 `command.wordcloud.mask`     | 删除本群词云形状                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 设置词云默认形状     | `/设置词云默认形状`                                                    | 超级用户 或 `command.wordcloud.default_mask`         | 发送一张图片作为所有词云的默认形状，每个群都会改变                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 删除词云默认形状     | `/删除词云默认形状`                                                    | 超级用户 或 `command.wordcloud.default_mask`         | 删除默认词云形状，继续使用词云默认的矩形                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 开启词云定时发送     | `/开启词云<类型>定时发送` 或<br />`/开启词云<类型>定时发送` + `[时间]` | 超级用户/群主/管理员 或 `command.wordcloud.schedule` | 开启本群定时发送词云，类型支持 `每日`、`每周`、`每月`、`每年`。默认发送上一完整周期：每日发送昨日词云；每周在周一发送上周词云；每月在 1 日发送上月词云；每年在 1 月 1 日发送去年词云。<br />添加 `--last` 或使用 `开启词云每周周期末定时发送` 这样的快捷命令，可在周期最后一天发送截至触发时间的词云；添加 `--complete` 或使用 `开启词云每周完整周期定时发送` 可显式使用完整周期模式。<br />没有指定模式时使用 `wordcloud_default_schedule_mode`。没有指定时间时，完整周期默认在 `00:00` 发送，周期末默认在 `23:59:59` 发送；如果配置了 `wordcloud_default_schedule_time`，则使用该配置。<br />如果时间没有包含时区信息，则根据 `wordcloud_timezone` 配置项确定时区。<br />时间的格式为 [ISO 8601](https://docs.python.org/zh-cn/3/library/datetime.html#datetime.time.fromisoformat)，例如：`开启词云每周定时发送 23:59:59` |
| 关闭词云定时发送     | `/关闭词云<类型>定时发送`                                              | 超级用户/群主/管理员 或 `command.wordcloud.schedule` | 关闭本群指定类型的词云定时发送                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 查看词云定时发送状态 | `/词云<类型>定时发送状态`                                              | 超级用户/群主/管理员 或 `command.wordcloud.schedule` | 查看指定类型的定时发送状态                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
